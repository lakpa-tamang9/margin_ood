...
from dataset_utils import validation_split
...
parser.add_argument(
    ...
    "-s",
    type=str,
    default="./hendrycks_method/resnet",
...
if args.dataset == "cifar10":
    ...
    train_data_in = dset.CIFAR100(
        "/share/data/vision-greg/cifarpy", train=True, transform=train_transform
    )
    test_data = dset.CIFAR100(
        "/share/data/vision-greg/cifarpy", train=False, transform=test_transform
    )
    num_classes = 100
